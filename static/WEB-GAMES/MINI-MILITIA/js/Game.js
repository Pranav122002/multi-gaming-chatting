 ...
 */
 var mini_militia_highscore = window.localStorage.getItem("mini_militia_highscore");
 if (mini_militia_highscore == undefined) {

   window.localStorage.setItem("mini_militia_highscore", 0);
 }

 function display_score() {
    alert("Highscore : " + mini_militia_highscore);
  }
...
function Game(canvas, resources) {
    ...
    this.respawn = function () {
        ...
        if (mini_militia_highscore < _this.shyame.actor.score) {
            mini_militia_highscore = _this.shyame.actor.score;
            window.localStorage.setItem("mini_militia_highscore", mini_militia_highscore)
            alert("new highcore : " + mini_militia_highscore)
        } 
